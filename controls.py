class Controls:
    def __init__(self, base):
        ...
        base.accept("w", self.update_key_map, ["forward", 1])
        base.accept("w-up", self.update_key_map, ["forward", 0])
        base.accept("s", self.update_key_map, ["backward", 1])
        base.accept("s-up", self.update_key_map, ["backward", 0])
        base.accept("a", self.update_key_map, ["left", 1])
        base.accept("a-up", self.update_key_map, ["left", 0])
